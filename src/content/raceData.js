  ...
  links: [
    {
      ...
      data: [
        ...
        },
        {
          ...
          key: "race-properties",
          value: [
            `+2 Сила, –2 Интеллект, –2 Обаяние: Полуорки сильны, но их
            орочье наследие, делает их угрюмыми и грубыми`,
            `Средний рост: Как существа среднего роста, полуорки не
            имеют каких-то бонусов или штрафов из-за своего роста.`,
            `Базовая скорость полуорка 9 метров`,
            `Темновидение: полуорки (и орки) могут видеть в темноте
            до 18 метров. Они видят все черно-белым, но как обычным
            зрением, и способны перемещаться в темноте безо всяких
            источников света.`,
            `Кровь орков: При каких-то особых условиях и эффектах ка-
            сающейся расы орк, полуорк принимается как орк. К приме-
            ру, полуорк столь же уязвим к определенным эффектам как
            и его предки, может использовать особое орочье оружие,
            или магические предметы которые дают особые силы, если
            его держит орк. (Смотрите Справочник Монстров за допол-
            нительной информацией об орках, и Руководство Мастера
            Подземелий о магических предметах).`,
            `Автоматические Языки: Общий и Орков. Бонусные языки:
            Драконов, Гигантов, Гноллов, Гоблинов, Абисса. Особо раз-
            витые полуорки (они исключение) могут владеть языками
            своих союзников и конкурентов.`,
            `Желаемый класс: Варвар. Мультиклассовый персонаж орк,
