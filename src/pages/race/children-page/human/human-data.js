      ...
      PARAGRAPHS: [
        {
          isTable: false,
          VALUE: [
            `Так как люди очень часто перемешиваются друг с другом в жизни, они легко уживаются остальными
      ...
      PARAGRAPHS: [
        {
          ...
          VALUE: [
            ...
            `Языки: Люди общаются на Общем. Они очень способны в
      ...
      PARAGRAPHS: [
        {
          ...
          VALUE: [
            ...
            `Искатели Приключений: Люди авантюристы наиболее отважные, дерзкие, честолюбивые представители, смелой, бесстрашной, ценящей себя расы. Люди могут получать славу в
