      ...
      PARAGRAPHS: [
        {
          isTable: false,
          VALUE: [
            `Главный бог халфлингов Йондала Благословенная, защитница халфлингов. Йондала пообещала благословлять и защищать тех, кто следует её законам, защищает
      ...
      PARAGRAPHS: [
        {
          ...
          VALUE: [
            ...
            мало пишут на своем собственном языке, в отличие от дварфов, эльфов и гномов, у них богатой библиотеки письменных
            работ. Но у них очень сильна традиция устного повествования. И хотя язык халфлингов не секретен, они не очень желает делиться им с другими. Практически все халфлинги разговаривают на Общем, он необходим им для общения с людьми
      ...
      PARAGRAPHS: [
        {
          isTable: false,
          VALUE: [
            `Амариллис, Чармайн, Кора, Евфемия,
